...
//  PlayingCard
//
//  Created by Marcos Felipe Souza on 06/01/19.
...
class PlayingCardView: UIView {
    ...
    private func centeredAttributedString(_ string: String, fontSize: CGFloat) -> NSAttributedString {
        ...
        font = UIFontMetrics(forTextStyle: .body).scaledFont(for: font) //get size by acessibility settings iphone
    ...
    //Get the change: Portrait , Landscape and change of acessibility (iPhone Settings )
    ...
    override func layoutSubviews() {
        ...
        //Translate, Scale or Rotate in transform
    ...
    override func draw(_ rect: CGRect) {
        self.contentMode = .redraw //Always content changes redraw ( bola oval )
...
extension PlayingCardView {
    //Constants are struct with static let
    ...
    private var rankString: String {
        switch rank {
        case 1: return "A"
        case 2...10: return String(describing: rank)
        case 11: return "J"
        case 12: return "Q"
        case 13: return "K"
        default: return "?"
